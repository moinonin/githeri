...
|------|------|-------|-----|------|--------|-------------------------------|
| C1 | — | 03:59:56 | 03:59:56 | 1 | 0 |  | ERR: cat: packages/core/src/index.ts: No such file or d |
| C2 | — | 03:59:56 | 03:59:56 | 0 | 0 | 9.0.0 |
| C3 | C1,C2 | | | | | |
...
- **L1:** `test -f packages/pipeline/heartbeat/src/index.ts && grep -q 'HeartbeatStage' packages/pipeline/heartbeat/src/index.ts` FAIL ✅
