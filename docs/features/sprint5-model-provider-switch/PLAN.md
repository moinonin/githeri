...
Expected Deliverables: CREATE: Add CLI flags --provider (ollama|openroute, VERIFY: CLI flags are recognized and processed cor, CREATE: Add configuration for Ollama and OpenRoute, VERIFY: Environment variables are loaded correctly
Dependencies: None
...
|-------|---------|----------|
| L1 | `L1` | exit 0 |
## Stage 2: CLI flags are recognized and processed correctly

### Objective
VERIFY: CLI flags are recognized and processed correctly
...
### Execution Tasks
1. **VERIFY**: VERIFY: CLI flags are recognized and processed correctly
...
|-------|---------|----------|
| L2 | `L2` | exit 0 |
## Stage 3: Add configuration for Ollama and OpenRouter in .env file

### Objective
CREATE: Add configuration for Ollama and OpenRouter in .env file
...
### Execution Tasks
1. **CREATE**: CREATE: Add configuration for Ollama and OpenRouter in .env file
   - Write implementation
   - Write tests
   - Export from index
...
|-------|---------|----------|
| L3 | `L3` | exit 0 |
## Stage 4: Environment variables are loaded correctly
...
### Execution Tasks
1. **VERIFY**: VERIFY: Environment variables are loaded correctly
   - Run verification command
   - Confirm expected output
