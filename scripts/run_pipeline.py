...
SYSTEM_PROMPT = (
    ...
    "--- LOCAL GOAL ENHANCEMENTS (IMPROVE_SPEC) ---\\n"
        ...
        "    CRITICAL: blueprint MUST include all necessary import statements at the top!\\n"
        "    WRONG: blueprint: |\\n      @app.post('/api')\\n      async def foo(): ...\\n"
        ...
        "    REQUIRED for goals with type: 'create'.\\n"
        ...
        "    If type == 'create', acceptance_criteria is MANDATORY and must be non-empty.\\n"
        "\\n"
